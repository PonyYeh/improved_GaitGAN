...
class NetG(nn.Module):
    def __init__(self, nc=3, ngf=96):
        ...
        self.converter = nn.Sequential(
            ...
            SpectralNorm(nn.Conv2d(ngf, ngf*2, kernel_size=4, stride=2, padding=1, bias=False)),#bx96x32x32 --> bx192x16x16
#             nn.BatchNorm2d(ngf*2),
            nn.LeakyReLU(0.2, True),

            SpectralNorm(nn.Conv2d(ngf*2, ngf*4, kernel_size=4, stride=2, padding=1,bias=False)), #bx192x16x16 --> bx384x8x8
#             nn.BatchNorm2d(ngf*4),
            nn.LeakyReLU(0.2, True),

#             SpectralNorm(nn.Conv2d(ngf*4, ngf*8, kernel_size=4, stride=2, padding=1, bias=False)),#bx384x8x8 --> bx768x4x4
...
#             nn.LeakyReLU(0.2, True),
            nn.Conv2d(ndf*4, 1, kernel_size=4, stride=4, bias=False),   #bx768x4x4--> bx1x1x1           
        )
...
# #             nn.BatchNorm2d(ndf*8),
#             nn.LeakyReLU(0.2, True),
            nn.Conv2d(ndf*4, 1, kernel_size=4, stride=4, bias=False),
