...
class NetD(nn.Module):
    def __init__(self, nc=3, ndf=96):
        ...
        self.discriminator = nn.Sequential(
            ...
            nn.Conv2d(ndf, ndf*2, kernel_size=4, stride=2, padding=1, #bx96x32x32 --> bx192x16x16
                      bias=False),
#             nn.BatchNorm2d(ndf*2),
            nn.LeakyReLU(0.2, True),

            nn.Conv2d(ndf*2, ndf*4, kernel_size=4, stride=2, padding=1, #bx192x16x16 --> bx384x8x8
                      bias=False),
#             nn.BatchNorm2d(ndf*4),
            nn.LeakyReLU(0.2, True),

            nn.Conv2d(ndf*4, ndf*8, kernel_size=4, stride=2, padding=1, #bx384x8x8 --> bx768x4x4
                      bias=False),
