...
#             nn.ReLU(True),#bug
    ...
    def forward(self, x):
        out = self.converter1(x)
#         print("1",out.shape)
        out,p1 = self.attn1(out)
        out = self.converter2(out)
...
#             nn.Sigmoid()  # for WGAN
    ...
    def forward(self, x):
        out = self.discriminator1(x)
        out, p1 = self.attn1(out)
#         print("modelD_Self attn",out_attn.shape,p1.shape)
        out = self.discriminator2(out)
        out, p2 = self.attn2(out)
        out = self.last(out)
